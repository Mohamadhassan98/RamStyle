...
import img1 from './pic/clothes.jpg'
                ...
                <div style={info}>
                    ...
                    <div style={chartsBox}>
                        <div style={chartContainer}>
                            <p style={{fontSize:"20px",wordBreak:"normal",width:"20%",overflow:"hidden" }}>مشارکت</p>
                            <div style={{...chart,...color1,...percent100}}></div>
                        </div>

                        <div style={chartContainer}>
                            <p style={{fontSize:"20px",wordBreak:"normal",width:"20%",overflow:"hidden" }}>یادگیری</p>
                            <div style={{...chart,...color2,...percent70}}></div>
                        </div>

                        <div style={chartContainer}>
                            <p style={{fontSize:"20px",wordBreak:"normal",width:"20%",overflow:"hidden" }}>علاقه مندی</p>
